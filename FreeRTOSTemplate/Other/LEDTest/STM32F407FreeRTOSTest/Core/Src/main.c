...
int main(void)
{
  ...
  osThreadDef(LED0_Task, LED0, osPriorityNormal, 0, 128);
  LED0_TaskHandle = osThreadCreate(osThread(LED0_Task), NULL);

  /* definition and creation of LED1_Task */
  osThreadDef(LED1_Task, LED1, osPriorityIdle, 0, 128);
...
/* USER CODE BEGIN Header_LED0 */
/**
  * @brief  Function implementing the LED0_Task thread.
  * @param  argument: Not used
  * @retval None
  */
/* USER CODE END Header_LED0 */
void LED0(void const * argument)
{
  /* USER CODE BEGIN 5 */
  /* Infinite loop */
